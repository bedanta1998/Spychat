from spy_details import spy #importing variables from spydetails.py
...
def send_message():# functon for sending message
    ...
    original_image=raw_input("What is the origiin name of the image : ")#take name of original image as input
...
friends=[{'name':'Bedanta','age':20,'rating':4,'isonline':True,'chats':[]},{'name':'Jishu','age':20,'ratings':4.2,'isonline':True,'chats':[]}]#list to store friend details
